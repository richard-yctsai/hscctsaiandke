...
//
//// Standard Library
//#include "stdafx.h" // Keep it on the top!!! DON'T MOVE
...
//				//if (step == 120) {
//				//	csvfile.close();
//				//	cout << "writing file when step is 120!!!!!!!!!!!!!" << endl;
//				//	while(true) {
//				//		cout << "stuck!" << endl;
//				//	}
...
//				}
//
//				// 2. csvfile.open(csvfilename);
//				if (PIDRun::getExecutePID() == false)
//					csvfile.open(csvfilename);
//
//				// 3. resultfile.open(resultfilename);
